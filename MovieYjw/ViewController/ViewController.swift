...
class ViewController: UIViewController {
    ...
    func fetchMovieList() {
        ...
        guard let url = URL(string: "https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=\(Personal.API_KEY.rawValue)&targetDt=\(date)") else { return }
